...
# Create Traefik dynamic config to use the custom certificates
...
# =============================================================================
# Auto-generated by generate-certs.sh
# Delete this file to revert to Traefik's built-in self-signed certificate.
  ...
  stores:
    default:
      defaultCertificate:
        ...
        keyFile: /etc/traefik/certs/server.key
EOF
echo -e "${GREEN}✓ Created Traefik dynamic config: traefik/dynamic/certs.yml${NC}"

echo ""
echo -e "${GREEN}=== Certificates Generated Successfully ===${NC}"
echo "Certificate: $CERTS_DIR/server.crt"
echo "Private Key: $CERTS_DIR/server.key"
echo "Traefik Config: $DYNAMIC_CERTS_FILE"
echo ""
...
echo -e "${YELLOW}To revert to Traefik's default cert, delete traefik/dynamic/certs.yml${NC}"
